            ...
            <div className="sm:text-center lg:text-left">
              ...
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                <div className="rounded-md shadow">
                  <Link to="/register">
                    <Button className="w-full flex items-center justify-center px-8 py-3 bg-[#007bff] hover:bg-[#0069d9] text-white text-base font-medium rounded-md">
                ...
                <div className="mt-3 sm:mt-0 sm:ml-3">
                  <Link to="/register-org">
                    <Button variant="outline" className="w-full flex items-center justify-center px-8 py-3 text-[#00d4ff] border-[#00d4ff] hover:bg-blue-50 text-base font-medium rounded-md">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="transform -rotate-6 vs-card p-4">
                ...
                <div className="flex justify-end">
                  <div className="h-6 w-16 bg-[#007bff] rounded-full"></div>
                </div>
              </div>
              <div className="transform rotate-3 vs-card p-4">
                ...
                <div className="h-2 w-3/4 bg-gray-100 rounded-full mb-2"></div>
                <div className="flex justify-end">
                  <div className="h-6 w-16 bg-[#00d4ff] rounded-full"></div>
                </div>
              </div>
