...
const CareerSkills = () => {
  ...
  const skillAssessments = [
    { id: 1, name: "JavaScript", score: 78, total: 100, date: "2025-03-15" },
    { id: 2, name: "React", score: 82, total: 100, date: "2025-03-20" },
    { id: 3, name: "UI/UX Design", score: 65, total: 100, date: "2025-04-02" },
  ];
                        ...
                        <div className="grid gap-6 grid-cols-1 md:grid-cols-2">
                          <div className="space-y-4">
                            ...
                            <div className="p-4 rounded-lg border dark:border-gray-700">
                              <h4 className="font-medium mb-2">React Advanced Concepts</h4>
                            ...
                            <div className="p-4 rounded-lg border dark:border-gray-700">
                              <h4 className="font-medium mb-2">UI/UX Portfolio Workshop</h4>
                              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                                Create stunning portfolio projects in this hands-on workshop.
                              </p>
                              <Button size="sm">Start Learning</Button>
                            </div>
                          </div>
                          <div className="space-y-4">
                            ...
                            <div className="p-4 rounded-lg border dark:border-gray-700">
                              <h4 className="font-medium mb-2">TypeScript Essentials</h4>
                              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                                Master TypeScript to improve your code quality and maintainability.
                              </p>
                              <Button size="sm">Start Learning</Button>
                            </div>
                            <div className="p-4 rounded-lg border dark:border-gray-700">
                              <h4 className="font-medium mb-2">Data Visualization with D3.js</h4>
                              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                                Create interactive data visualizations for your projects.
                              </p>
                              <Button size="sm">Start Learning</Button>
                            </div>
                          </div>
